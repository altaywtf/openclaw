...
export const en: TranslationMap & {
  ...
  chat: {
    ...
    board: {
      ...
      commentOnCanvas: "Comment on Canvas",
      stopCommenting: "Stop commenting on Canvas",
      resumeCommenting: "Resume annotating ({count})",
      annotating: "Annotating",
      annotationToolbar: "Canvas annotation controls",
      exitAnnotationMode: "Exit annotation mode",
      discardAnnotations: "Discard annotations",
      stageAnnotation: "Add 1 annotation to the chat composer",
      stageAnnotations: "Add {count} annotations to the chat composer",
      commentHint: "Select an element to comment on",
      commentPlaceholder: "Add a comment…",
      commentInput: "Comment on selected Canvas element",
      addComment: "Add element comment",
      annotationNumber: "Annotation {count}",
      commentAdded: "Canvas annotation added.",
      annotationStaged: "Added 1 Canvas annotation to the chat composer.",
      annotationsStaged: "Added {count} Canvas annotations to the chat composer.",
      commentElementUnavailable: "No HTML element was found here. Try another spot.",
      commentLimitReached: "Remove an annotation from the composer before adding another.",
      commentChatUnavailable: "Open Board chat before adding Canvas feedback.",
    ...
    composer: {
      ...
      browserAnnotationDetails: "Annotation details",
      ...
      removeBrowserAnnotations: "Remove annotations",
