...
type ChatComposerViewContext = {
  ...
  placeholder: string;
  handleKeyDown: (event: KeyboardEvent, source?: HTMLTextAreaElement) => void;
            ...
            <div class="agent-chat__composer-input-row">
              <div class="agent-chat__composer-combobox">
                <textarea
                  ...
                  class="agent-chat__composer-source"
                ...
                ></textarea>
                <div
                  ${ref(state.composerEditorRef ?? undefined)}
                  class="agent-chat__composer-editor"
                ></div>
                <span
