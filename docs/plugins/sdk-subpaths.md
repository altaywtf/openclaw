...
runtime splinters have been removed; bundled-only helpers are private-local.
  ...
  <Accordion title="Provider subpaths">
    ...
    | `plugin-sdk/provider-catalog-shared` | Private-local after July 2026; `findCatalogTemplate`, `buildSingleProviderApiKeyCatalog`, `buildManifestModelProviderConfig`, `resolveMergedModelProviderConfig`, `findConfiguredProviderModel`, `createModelProviderRouteOverrideResolver`, `supportsNativeStreamingUsageCompat`, `applyProviderNativeStreamingUsageCompat` |
