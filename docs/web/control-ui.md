...
- The authenticated Control UI WebSocket calls `assistant.media.get` to check availability and mint a short-lived `mediaTicket` scoped to the exact source path.
