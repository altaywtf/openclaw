...
remain unchanged. This admission isolation does not change report-publication
supersession, including Periphery's same-head comment ordering.
...
| `macos-26`                      | Both `macos-swift` phases, both iOS build phases, and both screenshot shards always use GitHub-hosted capacity.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
