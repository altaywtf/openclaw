...
export function prepareProviderExtraParams(
  params: ProviderHookParams<ProviderPrepareExtraParamsContext>,
) {
  return (
...
export function resolveProviderExtraParamsForTransport(
  params: ProviderHookParams<ProviderExtraParamsForTransportContext>,
) {
  return (
...
export function wrapProviderStreamFn(params: ProviderHookParams<ProviderWrapStreamFnContext>) {
  return (
