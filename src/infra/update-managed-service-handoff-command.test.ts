...
vi.mock("./update-managed-service-handoff-lease.js", async (importOriginal) => ({
  ...(await importOriginal<typeof import("./update-managed-service-handoff-lease.js")>()),
  readManagedHandoffProcessStartTime: getFileLockProcessStartTimeMock,
}));
