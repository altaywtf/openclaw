...
const kimiCodingPresetAppliers = createProviderConnectionPresetAppliers({
  ...
  resolveParams: () => ({
    ...
    catalogModels: () =>
      buildKimiCodingProvider().models.filter((model) => model.id === KIMI_CODING_DEFAULT_MODEL_ID),
