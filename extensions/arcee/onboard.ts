...
export const { applyConfig: applyArceeConfig } = createProviderConnectionPresetAppliers<[]>({
...
export const { applyConfig: applyArceeOpenRouterConfig } = createProviderConnectionPresetAppliers<
  []
>({
