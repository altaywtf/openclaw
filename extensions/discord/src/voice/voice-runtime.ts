...
export class DiscordVoiceManager {
  ...
  join(
    ...
    // Configured conversation handoffs retain this capture and residency, rather
    // than borrowing a later registration or a newer join's transport ownership.
    return this.joinOwned(
      ...
      options?.captureOnly
        ? {
            isCurrent: () =>
              capture !== undefined &&
              this.getTranscripts(target) === capture &&
