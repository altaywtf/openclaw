...
describe("Discord model picker runtime choices", () => {
  it("keeps model-specific choices instead of borrowing another model's alternatives", () => {
  ...
  it("distinguishes an authoritative empty choice set from missing choice data", () => {
